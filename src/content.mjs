...
export const ru = {
  ...
  profile: {
    ...
    paras: [
      'Я веду проект от первого письма до закрывающих документов и отвечаю за результат на каждом отрезке: подписан ли договор, прошла ли делегация без сбоев, принял ли отчёт государственный заказчик.',
  ...
  practice: {
    ...
    kicker: 'Направления',
    title: 'Что я делаю',
    intro: 'Пять направлений. По каждому есть законченные проекты, они разобраны в следующем разделе.',
    items: [
      {
    ...
    items: [
      ...
      },
      {
        ...
        b: [
          ...
          'Единолично вёл финансовую отчётность: сверил около 10 договоров с подрядчиками по переводу, кейтерингу, персоналу и логистике.',
      ...
      },
      {
        ...
        b: [
          ...
          'Довёл трёх потенциальных клиентов до предварительного коммерческого расчёта через ознакомительные звонки; вёл шесть тёплых контактов, включая AKFA Group из Узбекистана, где работает больше 30 000 человек.',
        ],
        m: [
    ...
    jobs: [
      {
        ...
        b: [
          ...
          'Выстроил с нуля кадровое делопроизводство и комплаенс: правила внутреннего трудового распорядка, трудовые договоры, документы по охране труда. Ввёл в работу новых сотрудников.',
      ...
      },
      {
        ...
        b: [
          'Вёл 20 клиентов и составлял индивидуальные финансовые планы: постановка целей, формирование финансовой подушки, оптимизация бюджета, снижение долговой нагрузки. Целевого резерва достигли все клиенты.',
...
export const en = {
  ...
  profile: {
    ...
    paras: [
      'I run a project from the first letter to the closing documents and answer for the result at every stage: whether the agreement gets signed, whether the delegation passes without a hitch, whether the state client accepts the report.',
  ...
  practice: {
    ...
    kicker: 'Practice',
    title: 'What I do',
    intro: 'Five areas. Each has completed projects behind it, set out in the next section.',
    items: [
      {

...
export const ru = {
  ...
  geo: {
    ...
    items: [
      { key: 'Brazil', flag: 'br', name: 'Бразилия' },
      { key: 'Russia', flag: 'ru', name: 'Россия' },
      { key: 'United Arab Emirates', flag: 'ae', name: 'ОАЭ' },
      { key: 'Saudi Arabia', flag: 'sa', name: 'Саудовская Аравия' },
      { key: 'Ethiopia', flag: 'et', name: 'Эфиопия' },
      { key: 'Kenya', flag: 'ke', name: 'Кения' },
      { key: 'Madagascar', flag: 'mg', name: 'Мадагаскар' },
      { key: 'China', flag: 'cn', name: 'Китай' },
      { key: 'Uzbekistan', flag: 'uz', name: 'Узбекистан' },
      { key: 'Kazakhstan', flag: 'kz', name: 'Казахстан' },
      { key: 'India', flag: 'in', name: 'Индия' },
      { key: 'South Africa', flag: 'za', name: 'ЮАР' },
    ],
  },
...
export const en = {
  ...
  geo: {
    ...
    items: [
      { key: 'Brazil', flag: 'br', name: 'Brazil' },
      { key: 'Russia', flag: 'ru', name: 'Russia' },
      { key: 'United Arab Emirates', flag: 'ae', name: 'UAE' },
      { key: 'Saudi Arabia', flag: 'sa', name: 'Saudi Arabia' },
      { key: 'Ethiopia', flag: 'et', name: 'Ethiopia' },
      { key: 'Kenya', flag: 'ke', name: 'Kenya' },
      { key: 'Madagascar', flag: 'mg', name: 'Madagascar' },
      { key: 'China', flag: 'cn', name: 'China' },
      { key: 'Uzbekistan', flag: 'uz', name: 'Uzbekistan' },
      { key: 'Kazakhstan', flag: 'kz', name: 'Kazakhstan' },
      { key: 'India', flag: 'in', name: 'India' },
      { key: 'South Africa', flag: 'za', name: 'South Africa' },
    ],
  },
